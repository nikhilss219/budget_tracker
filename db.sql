...
-- Expenses
-- September 2024
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 100.50, '2024-09-01', 'Weekly groceries', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 75.25, '2024-09-02', 'More groceries', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (2, 1200, '2024-09-01', 'Monthly rent', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 45.99, '2024-09-01', 'Snacks and drinks', 'Expense');

-- February 2024
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 100.50, '2024-02-01', 'Weekly groceries', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 75.25, '2024-02-02', 'More groceries', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (2, 1200, '2024-02-03', 'Monthly rent', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 45.99, '2024-02-07', 'Snacks and drinks', 'Expense');
-- January 2024
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 60.00, '2024-01-01', 'Breakfast supplies', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 110.75, '2024-01-02', 'Household items', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (2, 50.25, '2024-01-03', 'Utilities bill', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 200.50, '2024-01-04', 'Electronics', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 15.99, '2024-01-05', 'Dining out', 'Expense');
-- December 2023
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 90.00, '2023-12-01', 'Christmas Gifts', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 120.75, '2023-12-02', 'New Year Party Supplies', 'Expense');
-- November 2023
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (1, 85.50, '2023-11-01', 'Thanksgiving Groceries', 'Expense');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (2, 900, '2023-11-02', 'Rent November', 'Expense');
-- Income
-- February 2024
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (3, 3000, '2024-02-02', 'Monthly salary', 'Income');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (4, 500, '2024-02-03', 'Freelance project', 'Income');
-- January 2024
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (3, 3200, '2024-01-01', 'Bonus', 'Income');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (4, 450, '2024-01-02', 'Consulting work', 'Income');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (3, 2800, '2024-01-03', 'Part-time job', 'Income');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (4, 600, '2024-01-04', 'Online sales', 'Income');
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (3, 1500, '2024-01-05', 'Freelance writing', 'Income');
-- December 2023
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (3, 3100, '2023-12-02', 'End of Year Bonus', 'Income');
-- November 2023
INSERT INTO Transactions (category_id, amount, date, description, type) VALUES (4, 700, '2023-11-02', 'Thanksgiving Freelance', 'Income');